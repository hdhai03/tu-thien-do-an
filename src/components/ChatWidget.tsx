...
export default function ChatWidget() {
    ...
    const handleSend = async (e: React.FormEvent) => {
        ...
        if (mode === "ai") {
            const newUserMsg: ChatMessage = { id: Date.now().toString(), text, sender: "user", createdAt: new Date() };
...
`;
                ...
                const systemInstruction = `Bạn là trợ lý ảo của nền tảng từ thiện Nuôi Em. Bạn giúp người dùng tìm hiểu cách sử dụng trang web, gợi ý các dự án quyên góp và tổ chức từ thiện đang hoạt động trên nền tảng. Hãy trả lời ngắn gọn, thân thiện, hữu ích và bằng tiếng Việt.
